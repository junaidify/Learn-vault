    ...
    <div className="animate-fade-in mx-auto max-w-2xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm" style={{ color: 'var(--color-surface-800)', opacity: 0.6 }}>
          Update your course details and video
        </p>
      </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          {step === 2 && (
            <div className="animate-fade-in space-y-6">
              <div>
                <p className="mb-2 text-sm" style={{ color: 'var(--color-surface-800)', opacity: 0.6 }}>
                  Upload a new video to replace the existing one, or skip to keep the current video.
                </p>
                <VideoUpload onFile={setVideoFile}
                             currentFileName={videoFile?.name ?? (course?.videoUrl ? 'Current video (S3)' : undefined)} />
              </div>
